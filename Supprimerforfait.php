...
<div id="page" class="container"/>
	<div id="header">
        ...
        <li class="current_page_item"><a href='Supprimerforfait.php' accesskey="4" title="">Supprimer un forfait</a></li>
	...
	<div id="main"/>
        ...
        <form id="formulaire" action="" method="get" >
      		...
      		<fieldset>
      		    <legend>SUPPRIMER FORFAIT : </legend>
...
@$id=$_GET['id'];
  ...
  if (!empty($id)) {
  	include 'connectAD.php';
		...
		$sql = "DELETE FROM fraisforfait WHERE id='$id';";
