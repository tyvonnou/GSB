...
<div id="page" class="container"/>
	<div id="header">
        ...
        <li><a href='Supprimerforfait.php' accesskey="4" title="Se déconnecter">Supprimer un visiteur</a></li>
			</ul>
		</div>
	</div>
	<div id="main"/>
           ...
           if (!empty($login)) {
             include 'connectAD.php';
         		...
         		$sql = "INSERT INTO visiteur (id, nom, prenom, login, mdp, adresse, cp, ville, dateEmbauche, Type)
                    VALUES ('".$id."','".$nom."','".$prenom."','".$login."','".$mdp."','".$adresse."','".$cp."','".$ville."','".$dateEmbauche."','".$Type.");";
